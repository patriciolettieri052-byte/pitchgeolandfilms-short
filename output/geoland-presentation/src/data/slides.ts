...
export const slides: SlideData[] = [
...

  {
    id: 22,
    title: "",
    text: `<div class='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 md:gap-4 justify-center items-start w-full max-w-[1400px] mx-auto mt-4'><div class='flex flex-col items-center text-center w-full'><div class='scale-[1.15] origin-top print:scale-100 mb-6'><img src='team/pepe_transparent.png' class='w-36 h-36 md:w-44 md:h-44 object-cover object-top [mask-image:linear-gradient(to_bottom,black_60%,transparent_100%)] print:[mask-image:none]' /></div><h3 style="font-family:'League Gothic',sans-serif;font-size:1.4rem;letter-spacing:0.12em;" class='text-white mb-2 uppercase'>José Luis Curcio</h3><h4 class='text-white/40 tracking-[0.2em] text-[10px] uppercase mb-4' style="font-family:'Arimo',sans-serif;">Co-Founder, Product Vision & Strategy</h4><p style="font-family:'Arimo',sans-serif;" class='text-white/70 text-xs leading-relaxed font-light text-center max-w-[240px] mx-auto'>18+ años en campañas globales (Coca-Cola, Ford, Samsung); origen directo de GEOLAND.</p></div><div class='flex flex-col items-center text-center w-full'><div class='mb-6'><img src='team/pato_transparent.png' class='w-36 h-36 md:w-44 md:h-44 object-cover object-top [mask-image:linear-gradient(to_bottom,black_60%,transparent_100%)] print:[mask-image:none]' /></div><h3 style="font-family:'League Gothic',sans-serif;font-size:1.4rem;letter-spacing:0.12em;" class='text-white mb-2 uppercase'>Patricio Lettieri</h3><h4 class='text-white/40 tracking-[0.2em] text-[10px] uppercase mb-4' style="font-family:'Arimo',sans-serif;">Co-Founder - Data Infrastructure</h4><p style="font-family:'Arimo',sans-serif;" class='text-white/70 text-xs leading-relaxed font-light text-center max-w-[240px] mx-auto'>15+ años en marketing analytics e IA aplicada para marcas como John Deere y Porsche.</p></div><div class='flex flex-col items-center text-center w-full'><div class='mb-6'><img src='team/damian_transparent.png' class='w-36 h-36 md:w-44 md:h-44 object-cover object-top [mask-image:linear-gradient(to_bottom,black_60%,transparent_100%)] print:[mask-image:none]' /></div><h3 style="font-family:'League Gothic',sans-serif;font-size:1.4rem;letter-spacing:0.12em;" class='text-white mb-2 uppercase'>Damián Scheck</h3><h4 class='text-white/40 tracking-[0.2em] text-[10px] uppercase mb-4' style="font-family:'Arimo',sans-serif;">Co-Founder & CTO</h4><p style="font-family:'Arimo',sans-serif;" class='text-white/70 text-xs leading-relaxed font-light text-center max-w-[240px] mx-auto'>CTO de Mythology Labs; lidera arquitectura técnica y escalabilidad de la plataforma.</p></div><div class='flex flex-col items-center text-center w-full'><div class='scale-[1.25] origin-top print:scale-100 mb-6'><img src='team/juancarlos_transparent.png' class='w-36 h-36 md:w-44 md:h-44 object-cover object-top [mask-image:linear-gradient(to_bottom,black_60%,transparent_100%)] print:[mask-image:none]' /></div><h3 style="font-family:'League Gothic',sans-serif;font-size:1.4rem;letter-spacing:0.12em;" class='text-white mb-2 uppercase'>Juan Carlos Casalderrey</h3><h4 class='text-white/40 tracking-[0.2em] text-[10px] uppercase mb-4' style="font-family:'Arimo',sans-serif;">Co-Founder & Engineering Strategy</h4><p style="font-family:'Arimo',sans-serif;" class='text-white/70 text-xs leading-relaxed font-light text-center max-w-[240px] mx-auto'>Arquitecto de sistemas y co-founder de Mythology Labs.</p></div><div class='flex flex-col items-center text-center w-full'><div class='scale-[1.12] origin-top print:scale-100 mb-6'><img src='team/oliver_transparent.png' class='w-36 h-36 md:w-44 md:h-44 object-cover object-top [mask-image:linear-gradient(to_bottom,black_60%,transparent_100%)] print:[mask-image:none]' /></div><h3 style="font-family:'League Gothic',sans-serif;font-size:1.4rem;letter-spacing:0.12em;" class='text-white mb-2 uppercase'>Oliver Garland</h3><h4 class='text-white/40 tracking-[0.2em] text-[10px] uppercase mb-4' style="font-family:'Arimo',sans-serif;">Co-Founder & Industry Strategy Vision</h4><p style="font-family:'Arimo',sans-serif;" class='text-white/70 text-xs leading-relaxed font-light text-center max-w-[240px] mx-auto'>Founder de Olga Lee y Mamma Team. 25+ años produciendo campañas AAA globales.</p></div></div>`,
    variant: "texto",
    backgroundMedia: "3.mp4",
    overlayOpacity: 85,
    align: "center",
